...
static int rpng_x_display_image(void)
{
    ...
    FILE *fp = fopen("transparentdata.txt","w");
        ...
        for (lastrow = row = 0;  row < image_height;  ++row) 
	{
            ...
            if (image_channels == 3) {
                for (i = image_width;  i > 0;  --i) {
                    ...
                    green = *src++;
                    blue  = *src++;
		    fprintf(fp,"%d %d %d %d ",(uch)red,(uch)green,(uch)blue,0);	
//#ifdef NO_24BIT_MASKS
                    //pixel = (red   << RShift) |
                    //        (green << GShift) |
                    //        (blue  << BShift);
...
//#endif
	     ...
	     else /* if (image_channels == 4) */ 
	      {
                for (i = image_width;  i > 0;  --i) 
	        {
                    r = *src++; g = *src++; b = *src++;
                    a = *src++;
		   fprintf(fp,"%d %d %d %d ",(uch)r,(uch)g,(uch)b,255- (uch)a);
                    //if (a == 255) {
                    //    red   = r;
                    //    green = g;
                    //    blue  = b;
        ...
        for (lastrow = row = 0;  row < image_height;  ++row) {
            ...
            if (image_channels == 3) {
                for (i = image_width;  i > 0;  --i) {
                    ...
                    //*dest++ = (char)((pixel >>  8) & 0xff);
                    //*dest++ = (char)( pixel        & 0xff);
		    fprintf(fp,"%d %d %d %d ",(uch)red,(uch)green,(uch)blue,255);	
                }
            } else /* if (image_channels == 4) */ {
                for (i = image_width;  i > 0;  --i) {
                    r = *src++;
